# crontab -e
# 0 * * * * python3 /home/nfs/telegram/gpio/temperatura/bmp180/insertTemperatura.py
# 15 * * * * python3 /home/nfs/telegram/gpio/temperatura/bmp180/insertTemperatura.py
# 30 * * * * python3 /home/nfs/telegram/gpio/temperatura/bmp180/insertTemperatura.py
# 45 * * * * python3
...
# CREATE TABLE historicoTemperatura(id INTEGER PRIMARY KEY NOT NULL,
# temperatura FLOAT NOT NULL, humedad FLOAT, presion FLOAT, data DATETIME
# NULL);
...
SQL_TEMPERATURA_INSERT = 'INSERT INTO historicoTemperatura(temperatura, presion, data) VALUES (temp1, pressure1, ' + \
    globalVars.DATETIME_NOW + ');'
temperature = None
pressure = None
...
def insertTemperaturePressure():
    ...
    try:
        ...
        sqlExec = SQL_TEMPERATURA_INSERT.replace('temp1', str(
            round(temperature, 1))).replace('pressure1', str(round(pressure, 1)))
        ...
        globalVars.toLogFile(
            'Error insertTemperaturePressure: ' + str(e) + '\n')
        return None
    finally:
        temperatureDB.close()
